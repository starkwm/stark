...
class Context {
    ...
    func setup() {
        guard let bindLibPath = Bundle.main.path(forResource: "JavaScript/bind", ofType: "js") else {
            fatalError("Could not find bind.js")
        }

        guard let eventLibPath = Bundle.main.path(forResource: "JavaScript/event", ofType: "js") else {
            fatalError("Could not find event.js")
        }

        guard let taskLibPath = Bundle.main.path(forResource: "JavaScript/task", ofType: "js") else {
            fatalError("Could not find task.js")
        }

        guard let timerLibPath = Bundle.main.path(forResource: "JavaScript/timer", ofType: "js") else {
