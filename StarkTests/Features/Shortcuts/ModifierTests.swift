...
struct ModifierTests {
  @Test
  func resolvesCanonicalModifiersAndIgnoresDuplicates() {
  ...
  @Test
  func fallsBackToGenericEventMasksWhenDeviceMasksAreAbsent() {
  ...
  @Test
  func genericModifiersMatchEitherSide() {
  ...
  @Test
  func sidedModifiersMatchOnlyTheirSide() {
